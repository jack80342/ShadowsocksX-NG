        ...
        openPanel.begin { (result) -> Void in
            ...
            if (result.rawValue == NSFileHandlingPanelOKButton && (openPanel.url) != nil) {
                ...
                if (fileManager.fileExists(atPath: filePath) && filePath.hasSuffix("json")) {
                    ...
                    let readString = String(data: data!, encoding: String.Encoding(rawValue: String.Encoding.utf8.rawValue))!
                    let readStringData = readString.data(using: String.Encoding(rawValue: String.Encoding.utf8.rawValue))
